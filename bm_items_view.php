...
<div class="container-fluid">
  <div class="row">
   <h1> <span class="glyphicon glyphicon-eye-open"></span> View Items</h1>
  </div>
</div></div>
...
<div class="table-responsive" id="divToPrint">
 ...
 <?php
   ...
   $Upadte = mysqli_query($conn_db,"UPDATE bm_items SET item_status=0 WHERE item_id='$item_id'")or die("Error with querry");
  ...
  <strong>Enabled!</strong> Status has be enabled.
   ...
   $Upadte = mysqli_query($conn_db,"UPDATE bm_items SET item_status=1 WHERE item_id='$item_id'")or die("Error with querry");
  ...
  <strong>Disabled!</strong> Status has be disabled.
	...
	$GetItems = mysqli_query($conn_db,"SELECT * FROM bm_items") or die("Error with querry");
